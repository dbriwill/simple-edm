...
public class GedNodeServiceTest {
    ...
    public void libraryHasExpectedChildren() {
        ...
        List<GedNode> attemptedResult = Arrays.asList(new GedNode[] { gedDirectory, documentUnderLibrary });
    ...
    public void directoryHasExpectedChildren() {
        ...
        List<GedNode> attemptedResult = Arrays.asList(new GedNode[] { directoryWithDirectoryParent, gedDocument });
    ...
    public void libraryShouldBeFindByPath() {
        GedNode node = gedNodeService.findOneByPath("library");
    ...
    public void directoryShouldBeFindByPath() {
        GedNode node = gedNodeService.findOneByPath("library/directory");
    ...
    public void documentShouldBeFindByPath() {
        GedNode node = gedNodeService.findOneByPath("library/directory/document");
    ...
    public void subdirectoryShouldBeFindByPath() {
        GedNode node = gedNodeService.findOneByPath("library/directory/subdirectory");
